...
# Outputs: data/derived/teams_messages_anon.csv,
#          data/derived/audit_unmapped_tokens.csv
...
# Outputs: data/derived/p3_eval_anonymized.csv,
#          data/derived/p3_eval_anonymization_errors.csv
```
...
data/
  ├── derived/                      # ✓ Included — anonymized processed data
